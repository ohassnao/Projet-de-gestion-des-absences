...
import javaswingdev.main.Swing;
import javaswingdevAd.form.*;
import javaswingdevAd.menu.EventMenuSelected;
import javaswingdevAd.menu.Menu;
...
public class Main extends javax.swing.JFrame {
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int index, int indexSubMenu) {
                if (index == 0) {
                    ...
                    try {
						showForm(new Form_Etds());
					} catch (SQLException e) {}
                }
                else if(index == 11){
                	if(indexSubMenu == 1) {
                    	showForm(new Form_Choice());
                	}
                	else if(indexSubMenu == 2) {
                		showForm(new Form_Choice1());
                	}
                	else if(indexSubMenu == 3) {
                		showForm(new Form_Choice2());
                	}
                }
    ...
    private void initComponents() {
        ...
        menu = new javaswingdevAd.menu.Menu();
