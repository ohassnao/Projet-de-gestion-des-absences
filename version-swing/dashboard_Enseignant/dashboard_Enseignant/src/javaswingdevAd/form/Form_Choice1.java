...
public class Form_Choice1 extends javax.swing.JPanel {

    public Form_Choice1() {
        initComponents();
        lb.setText("Mise à jour des informations");
        addButtonPanel();
    }
    ...
    private void addButtonPanel() {
        ...
        btnEnseignants.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                parent.remove(Form_Choice1.this);
                parent.revalidate();
                parent.repaint();
                
                // Create and add the new panel to the parent container
                JPanel formCreateEns = new Update_Professor();
        ...
        btnEtudiants.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Create and add the new panel to the parent container
                JPanel formUpdateEtd = new Update_Etutdiant();
        ...
        btnModules.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Create and add the new panel to the parent container
                JPanel formUpdateModule = new Update_Module();
