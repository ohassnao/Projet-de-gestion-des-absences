...
<%
	String etd_name = request.getParameter("etd_name");
        ...
        <div class="app-body">
            ...
            <div class="app-body-main-content">
                ...
                <section class="transfer-section">
					...
					<div class="transfers">
					    <% 
						    PreparedStatement pstmt1 = conn.prepareStatement("SELECT * FROM etudiants");
						    ResultSet rs2 = pstmt1.executeQuery();
						        
						    
						    while (rs2.next()) {
						        String nom1 = rs2.getString("nom");
						        String prenom1 = rs2.getString("prenom");
						        String email1 = rs2.getString("mail");
							%>
							    <div class="transfer">
				...
				<%
				String var = "electrodays";
					int idEns=0;
					String nom="", prenom="", dateNaissance="", mail="";
					PreparedStatement Query = conn.prepareStatement("SELECT * FROM etudiants WHERE nom = ?");
					Query.setString(1, etd_name);
					ResultSet resQ = Query.executeQuery();
					while(resQ.next()){
						idEns = resQ.getInt("id_etd");
						nom = resQ.getString("nom");
						prenom = resQ.getString("prenom");
						mail = resQ.getString("mail");
					}
                ...
                <p>You can update Students here!</p>
					...
					if (nom != null) {
					  try {
					    ...
					    PreparedStatement qu2 = conn.prepareStatement("SELECT id_etd FROM etudiants WHERE nom = ?");
					    qu2.setString(1, etd_name);
					    ResultSet rs_2 = qu2.executeQuery();
					    int lastId1 = 0;
					    while(rs_2.next()){
					    	lastId1 = rs_2.getInt("id_etd");
					    }
					    ...
					    PreparedStatement ensStat = conn.prepareStatement("UPDATE etudiants SET nom = ?, prenom = ?, mail = ? WHERE id_etd = ?");
					    ensStat.setInt(4, lastId1);
