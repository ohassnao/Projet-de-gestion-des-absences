...
public class Loginteacherservlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "SELECT e.nom_ens FROM compte c INNER JOIN enseignants e ON c.id_compte = e.id_compte WHERE c.login = ? AND c.pwd = ?";
            ...
            if (resultSet.next()) {
                // Login successful
                String NomEnseignant = resultSet.getString("nom_ens");
            	response.sendRedirect("add-courses.jsp?username=" + NomEnseignant);
            } else {
                // Login failed
